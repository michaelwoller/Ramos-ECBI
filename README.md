Analysis.R contains all the analysis included within the paper as well as a few others that were not included. The script also contains the code for visual plots. 
